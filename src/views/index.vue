							...
							<el-col :span="8">
								<div class="homeMenu">  
									...
									<el-tooltip content="联系我们" placement="bottom" effect="light">
										<div class="nav-list-icon">	
											<a class="link-icon" hidefocus="true" href="http://www.baidu.com" target=_blank><el-icon><PhoneFilled /></el-icon></a> 
										</div>
									</el-tooltip>
									<div class="nav-list-user">
										<el-dropdown size="large">
											...
											<template #dropdown>
												<el-dropdown-menu>
													<el-dropdown-item :icon="Tools" @click="$router.push({path: '/admin/control/staff/manage/editStaff',query:{ userId: state.sysUsers.userId}})">个人设置</el-dropdown-item>
...
<script lang="ts" setup>
    import { ComponentInternalInstance, computed, getCurrentInstance, nextTick, onMounted, reactive, watch } from 'vue';
    import pinia from '@/store/store'
    import {useStore} from '@/store'
    import { storeToRefs } from 'pinia';
    import { AxiosResponse } from 'axios';
    import { useRoute, useRouter } from 'vue-router';
	import { analyzeUrlParam, objToStrMap, strMapToObj } from '@/utils/tool';
